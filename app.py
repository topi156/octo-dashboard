...
@@ -1800,7 +1820,12 @@ def show_overview():
     with col1:
...
@@ -1816,28 +1841,66 @@ def show_overview():
...
@@ -1900,37 +1963,51 @@ def show_overview():
...
@@ -3068,8 +3145,9 @@ def show_investors():
...
@@ -3098,6 +3176,7 @@ def show_investors():
...
+                                        commit_val = normalize_commitment_amount(commit_val)
                                         ...
                                         count += 1
@@ -3119,7 +3198,7 @@ def show_investors():
                 with c1:
                     st.write(f"**{inv['name']}**")
                 with c2:
...
@@ -3147,13 +3226,14 @@ def show_investors():
...
@@ -3179,7 +3259,7 @@ def show_investors():
...
+        inv_commit = investor_commitment_value(inv)
         ...
         row = {
             "id": inv["id"],
@@ -3237,36 +3317,51 @@ def show_investors():
